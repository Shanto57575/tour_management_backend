...
const sendOTPService = (email, name) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield user_model_1.User.findOne({ email });
    if (!user) {
        throw new AppError_1.default(http_status_codes_1.default.NOT_FOUND, "User Not Found");
    }
    if (user.isVerified) {
        throw new AppError_1.default(http_status_codes_1.default.CONFLICT, "You Are already Verified");
    }
