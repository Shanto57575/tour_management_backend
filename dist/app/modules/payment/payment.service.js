...
const initPaymentService = (bookingId) => __awaiter(void 0, void 0, void 0, function* () {
    const payment = yield payment_model_1.Payment.findOne({ booking: bookingId });
    if (!payment) {
        throw new AppError_1.default(http_status_codes_1.default.NOT_FOUND, "Payment Not Found! you didn't booked this tour");
    }
...
const successPayment = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!cloudinaryResult) {
            throw new AppError_1.default(500, "Error uploading pdf");
        }
...
const failPayment = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        }, { status: payment_interface_1.PAYMENT_STATUS.FAILED }, { new: true, runValidators: true, session });
...
const getInvoiceDownloadUrlService = (paymentId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!payment.invoiceUrl) {
        throw new AppError_1.default(404, "No Invoice Found");
    }
